    ...
    if ($config_file) {
		...
		$can = 1;
          $con1 = mysqli_connect($_POST['sql_host'], $_POST['sql_user'], $_POST['sql_pass'], $_POST['sql_name']);
           ...
           $success = 'Element successfully installed, please wait ..';
        } else {
          $ServerErrors[] = "Error found while installing, please contact us.";
        }
      }
...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
        <title>Element Social | Installation</title>
          ...
          <div class="wo_install_wiz">
            <div>
                            ...
                            <div class="setting-well">
                                <?php if ($page == 'terms') { ?>
                                <div class="terms">
                                    <h5>LICENSE AGREEMENT: <a href="https://www.gnu.org/licenses/gpl-3.0.en.html" target="new">GNU-GPLV3 </a></h5>
                                    <p><strong>Element is an Open Source fork of the Wowonder PHP Script.</strong></p>
                                    <p><strong>NOTE:   This is a social media script based on the Wowonder php script. With all calls to wowonder removed. All apps verified and all back doors completely removed. 100% Independent. .</strong></p>
                                    <p><strong>We call it Element. Created by the Megalo Technologies Corporation</strong></p>
                                    <p><strong>WE OFFER FREE SUPPORT FOR THIS VERSION <a href="https://tawk.to/chat/6042274c1c1c2a130d654aa5/1fhc9u7ip" target="new">https://tawk.to/chat/6042274c1c1c2a130d654aa5/1fhc9u7ip</a></strong><br>
                                      <br>
                                    </p>
                                    <hr>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>element.sql</td>
                        <td>Required element.sql for the installation <small>(Located in ./Script)</small></td>
                    ...
                    <div class="setting-saved-update-alert milinglist"></div>
                                ...
                                <div class="req">
                                    <p>Congratulations! Element has been successfully installed and your website is ready.</p>
                  <p>Login to your admin panel to make changes and modify any default content according to your needs.</p>
                  <br>
                  <p>If you have any question, please <a href="https://tawk.to/chat/6042274c1c1c2a130d654aa5/1fhc9u7ip" class="main">let us know</a>. </p>
                                    <br><br>
                  ...
                  <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <span class="help-block">Enter install code 567643562964691654501, <a target="_blank" href="https://www.megalotechnologies.com">Built By Megalo Technologies</a>.</span>
                                            </div>
                      <div class="col-md-2"></div>
                                        </div>
                                        <div class="form-group">
